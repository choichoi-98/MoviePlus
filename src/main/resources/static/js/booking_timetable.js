				...
				if(data.length > 0){
					$(data).each(function (index, item) {
						...
						var jojosimya = item.theater_SCHEDULE_TYPE
							...
							output += '<span class="seat"><strong class="now"title="잔여 좌석">'+item.theater_SCHEDULE_BOOKED_CNT+'</strong><span>/</span><em class="all" title="전체 좌석">'+item.theater_ROOM_SEAT_CNT+'</em></span></div>';

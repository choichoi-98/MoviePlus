				...
				<div class="top2">
					...
					<div class="link">
						<a href="${pageContext.request.contextPath}/member/modifyinfo"
							title="개인정보수정 페이지로 이동">개인정보수정</a> <a href="#" id="bfrClassSearch"
							class="" title="지난등급 상세보기">지난등급조회</a>
					</div>
				...
				<div class="bottom2">
					...
					<div class="items theater" id="myFaverBrch">
						...
						<div class="list">
							...
							<ol>
								<c:forEach var="favTheater" items="${favTheaterList }" varStatus='status'>
			...
			<div class="column mt70">
				...
				<div class="col left" id="myStory">
					<div class="tit-util">
						...
						<div class="right">
							<a href="#" class="button gray-line small btn-modal-open"
								w-data="600" h-data="470" title="본 영화 등록">본 영화 등록</a>
						</div>
					</div>

					<div class="box-border link-movie-story">
						<a href="#" title="본 영화 탭으로 이동"> <em>0</em> <span>본 영화</span>
						</a> <a href="#" title="관람평 탭으로 이동"> <em>0</em> <span>관람평</span>
						</a> <a href="#" title="보고싶어 탭으로 이동"> <em>0</em> <span>보고싶어</span>
						</a> <a href="#" title="무비포스트 탭으로 이동"> <em>0</em> <span>무비포스트</span>
						</a>
					</div>
				</div>
				<!--// left -->

...
<head>
		<header id="header" class="main-header">
				...
				<div class="link-area">
					<a href="#" id="header-sitemap-btn" class="header-open-layer btn-layer-sitemap" title="사이트맵">사이트맵</a>
					<a href="#" id="header-search-btn" class="header-open-layer btn-layer-search" title="검색">검색</a> <!-- target on // X 표시 -->
					<a href="#" class="link-ticket" title="상영시간표">상영시간표</a>
					<a href="#" id="header-my-megabox-btn" class="header-open-layer btn-layer-mymega" title="나의 메가박스">나의 메가박스</a>
				</div>
				...
				<div id="layer_sitemap" class="header-layer layer-sitemap"> <!-- 큰 메뉴바 header-layer layer-sitemap on -->
					<!-- wrap -->
					<div class="wrap">
				...
				<!-- 레이어 : 검색 -->
				<div id="layer_header_search" class="header-layer layer-header-search"> <!-- "header-layer layer-header-search target on" -->
					<div class="wrap">
			...
			<div id="layer_mymega2" class="header-layer layer-mymege2"> <!-- on -->
				<a href="#" class="ir" title="나의 메가박스 레이어 입니다.">나의 메가박스 레이어 입니다.</a>
			
				<!-- wrap-->
				<div class="wrap" style="display:;">
			
					<div class="login-after" style="display:none;">   <!-- 로그인 이후 -->
						<div class="inner">
							<div class="box">
								<div class="mbimg"><img src="" alt="프로필 사진"></div>
								<div class="name"><span></span>임시님</div>
							...
							<div class="box coupon">
								<div class="tit">
									<a class="linkA" href="#" title="쿠폰"><span>쿠폰</span></a>
									<a class="linkA" href="#" title="멤버십 포인트"></a>
								</div>
					...
					<div class="login-before" style=""> <!-- 로그인 전 -->

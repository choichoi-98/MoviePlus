		...
		<div id="contents">
			<div class="inner-wrap">
				...
				<div class="membershipCard">
					<div class="tt">
						MEGABOX<span>MEMBERSHIP</span>
					</div>
					<div class="tx">메가박스 멤버십 회원에게만 제공되는 혜택</div>
					<img src="${pageContext.request.contextPath}/resources/image/membership/card_img.png" alt="맴버쉽 카드">
				</div>

				<h3 class="tit3">메가박스 멤버십 혜택</h3>
				...
				<div class="pointUse" id="pointUse">
					...
					<dl class="dotListv2">
						...
						<dt>오프라인에서 포인트 사용 시, 멤버십 카드 또는 메가박스 앱을 반드시 제시해야하며, 개인별로 설정된
					...
					<dl class="dotListv2">
						...
						<dt>발행된 쿠폰은 로그인 후 ‘나의 메가박스 &gt; 쿠폰’에서 확인 가능합니다.</dt>
					...
					<dl class="dotListv2">
						...
						<dt>메가박스 회원가입 시 모바일 카드가 자동 발급됩니다.</dt>
						<dt>플라스틱 카드 수령을 원하시는 분은 메가박스 현장 매표소에서 받으실 수 있습니다.</dt>
						<dt>플라스틱 카드를 수령하신 경우 홈페이지 ‘나의 메가박스 &gt; 멤버십 포인트 &gt; 멤버십
					...
					<dl class="dotListv2">
						...
						<dt>메가박스 및 제휴사 할인, 포인트 결제 등을 통해 할인 받은 금액을 제외한 실제 고객님께서 현금,
					...
					<dl class="dotListv2">
						...
						<dt>메가박스에서 발행된 관람권은 영화 가격과 무관하게 관람권이 판매된 가격 기준으로 포인트가 적립됩니다.</dt>

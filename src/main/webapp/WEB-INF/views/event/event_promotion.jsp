...
<body>
	...
	<div class="container">
		...
		<div class="inner-wrap">
				...
				<div class="tab-list fixed">
					<ul>
						...
						<li class="" id="eventTab_"><a href="${pageContext.request.contextPath}/event" title="전체">전체</a></li>
							...
							<li id="eventTab_CED05" class="on">
							<a href="${pageContext.request.contextPath}/event/promotion" title="제휴/할인 탭으로 이동">제휴/할인</a></li>
		...
		<div id="boardSearch" class="inner-wrap" style="">
				...
				<c:set var="promotionEventCount" value="${promotionEventListCount}" />
				<p class="result-count"><strong>전체 <b>${promotionEventCount}</b>건</strong></p>
				...
				<ul>
					...
					<li>
						<a href="${pageContext.request.contextPath}/event/detail?num=${eventpromotion.EVENT_NUM}" data-no="14248" data-netfunnel="N" class="eventBtn" title="${eventpromotion.EVENT_SUBJECT}">
							...
							<p class="tit">
								${eventpromotion.EVENT_SUBJECT}
							</p>

							<p class="date">
								<span class="startdate">${eventpromotion.EVENT_STARTDATE}</span> ~ <span class="enddate">${eventpromotion.EVENT_ENDDATE}</span>
							</p>
						</a>
					</li>
					</c:if>

...
<body>
	...
	<div class="container">
		...
		<div id="boardSearch" class="inner-wrap" style="">
				...
				<c:set var="theaterEventCount" value="${theaterEventListCount}" />
				<p class="result-count"><strong>전체 <b>${theaterEventCount}</b>건</strong></p>
	...
	<div class="inner-wrap">
			...
			<div class="event-list ">
				...
				<ul>
					...
					<li>
						<a href="${pageContext.request.contextPath}/event/detail?num=${eventtheater.EVENT_NUM}" data-no="14248" data-netfunnel="N" class="eventBtn" title="${eventtheater.EVENT_SUBJECT}">
							<!--<p class="img"><img src="../../../static/pc/images/event/@img-event-list-megabox.jpg" alt="" /></p>-->
							<p class="img"> 
							<img src="${pageContext.request.contextPath}/upload${eventtheater.EVENT_FILE}" alt="" onerror="noImg(this);"></p>

							<p class="tit">
								${eventtheater.EVENT_SUBJECT}
							</p>

							<p class="date">
								<span class="startdate">${eventtheater.EVENT_STARTDATE}</span> ~ <span class="enddate">${eventtheater.EVENT_ENDDATE}</span>
							</p>
						</a>
					</li>
					</c:if>

...
<body>
	...
	<main class="main">
		...
		<!-- end main title -->
		<div class="col-7">
			<div class="theater-room-name">1관 
			<a href="#" class="main__table-btn main__table-btn--banned"> <i class="icon ion-ios-film feature__icon"></i></a>
			</div>
		...
		<div class="col-7">
			<div class="theater-room-name">2관 
			<a href="#" class="main__table-btn main__table-btn--banned"> <i class="icon ion-ios-film feature__icon"></i></a>
			</div>
			<table class="main__table">
				<thead>
		...
		<div class="col-7">
			<div class="theater-room-name">3관 
			<a href="#" class="main__table-btn main__table-btn--banned"> <i class="icon ion-ios-film feature__icon"></i></a>
			</div>

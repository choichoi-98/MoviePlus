...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/resources/css/manager_seat.css">
<body>
				...
				<div class="col-12">
					<form action="modifyRoomAction" class="form" method="post">
						<input type="hidden" name="${_csrf.parameterName}"
							...
							name="THEATER_ROOM_ID" value="${theaterRoom.THEATER_ROOM_ID }">
							...
							<div class="seat-container">
								<table id="seat-table">
									<tr class='seat-column' data-columm-alp='A'>
										<td class="seat-column-td"><button
												class="seat-column-btn">A</button></td>
									...
									<tr class='seat-column' data-columm-alp='B'>
										<td class="seat-column-td"><button
												class="seat-column-btn">B</button></td>
									...
									<tr class='seat-column' data-columm-alp='C'>
										<td class="seat-column-td"><button
												class="seat-column-btn">C</button></td>
									...
									<tr class='seat-column' data-columm-alp='D'>
										<td class="seat-column-td"><button
												class="seat-column-btn">D</button></td>
									...
									<tr class='seat-column' data-columm-alp='E'>
										<td class="seat-column-td"><button
												class="seat-column-btn">E</button></td>
									...
									<tr class='seat-column' data-columm-alp='F'>
										<td class="seat-column-td"><button
												class="seat-column-btn">F</button></td>
									...
									<tr class='seat-column' data-columm-alp='G'>
										<td class="seat-column-td"><button
												class="seat-column-btn">G</button></td>
									...
									<tr class='seat-column' data-columm-alp='H'>
										<td class="seat-column-td"><button
												class="seat-column-btn">H</button></td>
									...
									<tr class='seat-column' data-columm-alp='J'>
										<td class="seat-column-td"><button
												class="seat-column-btn">J</button></td>
									...
									<tr class='seat-column' data-columm-alp='K'>
										<td class="seat-column-td"><button
												class="seat-column-btn">K</button></td>
									...
									<tr class='seat-column' data-columm-alp='L'>
										<td class="seat-column-td"><button
												class="seat-column-btn">L</button></td>
									...
									<tr class='seat-column' data-columm-alp='M'>
										<td class="seat-column-td"><button
												class="seat-column-btn">M</button></td>

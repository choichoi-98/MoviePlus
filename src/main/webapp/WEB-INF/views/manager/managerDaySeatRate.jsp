			...
			<div class="row">
				...
				<div class="col-12">
						<table class="main__table">
							...
							<tbody>
							  <c:forEach var="seat" items="${daySeatList}">
								<tr>
									<td>
										<div class="main__table-text">${seat.RNUM}</div>
									</td>
									<td>
										<div class="main__user">
											<div class="main__meta">
												<h3>${seat.MOVIE_CODE}</h3>
											</div>
										</div>
									</td>
									<td>
										<div class="main__table-text">
										<a href="#">${seat.MOVIE_TITLE}</a>
										</div>
									</td>
									<td>
										<div class="main__table-text">${seat.ratio}%</div>
									</td>
									<td>

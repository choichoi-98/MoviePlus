			...
			<div id="contents" class="" style="padding-left : 250px;">
				...
				<div class="tab-block mb30" style="width:70%">
					<ul>
							...
							<button type="button" class="btn tabBtn" data-no="" title="전체공지 보기">전체</button></a></li>
						
							<li class="tabBtn on">
							<a href = "${pageContext.request.contextPath}/customer_service/adminnotice">
							<button type="button" class="btn" data-no="81" title="무비플러스 공지 보기">무비플러스 공지</button></a></li>
						
							<li class="tabBtn">
							<a href = "${pageContext.request.contextPath}/customer_service/regionnotice">
							<button type="button" class="btn" data-no="82" title="지점 공지 보기">지점 공지</button></a></li>
